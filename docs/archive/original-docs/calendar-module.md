...
|-------|-----------|------------|--------|
| **Default** | transparent | `#1C2C42` | pointer |
...
|---------|------|--------|------|-------|
| Month/Year header | Lato Bold | 700 | 17px | `#1C2C42` |
| Day headers (MON, TUE...) | Lato | 600 | 13px | `rgba(0,0,0,0.2)` |
| Day numbers | Lato Bold | 700 | 17px | `#1C2C42` / white / `#D9D9D9` |
| "Set date" label | Lato Bold | 700 | 17px | `#1C2C42` (on) / `#939393` (off) |
