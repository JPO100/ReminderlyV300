...
|-------|-----------|------------|--------|
| **Default** | transparent | `#4784F8` | pointer |
...
|---------|------|--------|------|-------|
| Month/Year header | Lato Bold | 700 | 17px | `#4784F8` |
| Day headers (MON, TUE...) | Lato | 600 | 13px | `rgba(0,0,0,0.2)` |
| Day numbers | Lato Bold | 700 | 17px | `#4784F8` / white / `#D9D9D9` |
| "Set date" label | Lato Bold | 700 | 17px | `#4784F8` (on) / `#939393` (off) |
