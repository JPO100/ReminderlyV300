...
- Text colour: `#939393` (unchecked) / `#2B5DA0` (checked)
...
| `#2B5DA0` | Dark navy | Icon ON state, text headings, active frequency button text, checked day text |
