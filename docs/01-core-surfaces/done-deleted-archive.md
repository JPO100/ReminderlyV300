...
- Done/deleted mode: Header background `#1C2C42`, white-filled tick with `#1C2C42` checkmark overlay

## Header

### Logo Tick State
The logo tick visual indicates the current view mode. In done/deleted mode, the header background changes to dark blue `#1C2C42` and the tick becomes a filled white circle with a dark blue checkmark.
...
- Active state: white background, dark blue `#1C2C42` text
...
**Step 1 (confirmation)**
- Label: "Clear all?"
- Visual: white background, dark blue `#1C2C42` text
...
**Done Reminder**
- Filled dark blue `#1C2C42` circle with white tick
...
**Done**
- Title: dark blue `#1C2C42`, no decoration
- Subtitle: dark blue `#1C2C42` or grey `#BABABA` (depending on state)
