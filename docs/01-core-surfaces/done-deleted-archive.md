...
- Done/deleted mode: Header background `#214677`, white-filled tick with `#214677` checkmark overlay

## Header

### Logo Tick State
The logo tick visual indicates the current view mode. In done/deleted mode, the header background changes to dark blue `#214677` and the tick becomes a filled white circle with a dark blue checkmark.
...
- Active state: white background, dark blue `#214677` text
...
**Step 1 (confirmation)**
- Label: "Clear all?"
- Visual: white background, dark blue `#214677` text
...
**Done Reminder**
- Filled dark blue `#214677` circle with white tick
...
**Done**
- Title: dark blue `#214677`, no decoration
- Subtitle: dark blue `#214677` or grey `#BABABA` (depending on state)
