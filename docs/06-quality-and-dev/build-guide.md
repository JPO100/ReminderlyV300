...
See [Architecture](../../00-overview/architecture.md) for complete file structure documentation.

## Development Constraints

See `/Claude.md` for strict development constraints:
- Surgical changes only
- No taste refactors
- Preserve UX/motion
- Never refresh the app
- No new hooks/contexts/abstractions
