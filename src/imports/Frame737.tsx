import svgPaths from "./svg-xgb5k8n9kr";
    ...
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <div className="h-[23.75px] relative shrink-0 w-[23.199px]" data-name="Union">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.1994 23.75">
          <g id="Union">
            <path d={svgPaths.p3c8ed900} fill="var(--fill-0, #141B34)" />
            <path d={svgPaths.p151bf500} fill="var(--fill-0, #141B34)" />
            <path clipRule="evenodd" d={svgPaths.p381e2b80} fill="var(--fill-0, #141B34)" fillRule="evenodd" />
          </g>
        </svg>
      </div>
      <p className="font-['Lato:Bold',sans-serif] leading-[23px] not-italic relative shrink-0 text-[#1c2c42] text-[17px] whitespace-nowrap">Show tutorial on every app start</p>
    </div>
  );
}
