        ...
        <div className="content-stretch flex flex-col gap-[10px] items-start relative w-full" data-name="Scrollable List Area" style={{ flex: 1, minHeight: 0, overflowY: 'auto' }}>
          ...
          >
            <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
              <p className="font-['Lato:Bold',sans-serif] leading-[23px] not-italic text-[17px]" style={{ color: includeDone ? '#214677' : '#C9C9C9' }}>Include done list items</p>
            </div>
            <div
          ...
          >
            <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
              <p className="font-['Lato:Bold',sans-serif] leading-[23px] not-italic text-[17px]" style={{ color: includeSmartReminderLists ? '#214677' : '#C9C9C9' }}>Include smart reminder lists</p>
            </div>
            <div
          ...
          >
            <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
              <p className="font-['Lato:Bold',sans-serif] leading-[23px] not-italic text-[17px]" style={{ color: includeSavedLists ? '#214677' : '#C9C9C9' }}>Include List templates</p>
            </div>
            <div
