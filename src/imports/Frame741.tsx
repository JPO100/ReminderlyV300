  ...
  return (
    <div className="h-[21.5px] relative shrink-0 w-[24px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 21.5002">
        <g id="Frame 738">
          <g id="Union">
            <path clipRule="evenodd" d={svgPaths.pa3f6300} fill="#4784F8" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p299691f0} fill="#4784F8" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p16049180} fill="#4784F8" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
