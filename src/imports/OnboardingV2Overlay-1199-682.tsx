...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[20.896px] items-center relative shrink-0">
      <Group1 />
      <div className="css-g0mm18 flex flex-col font-['Lato:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#214677] text-[15.323px] text-center">
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[2.786px] items-center relative shrink-0">
      <div className="bg-[#214677] h-[4.876px] rounded-[6.965px] shrink-0 w-[16.716px]" />
      <div className="bg-[#214677] rounded-[6.965px] shrink-0 size-[4.876px]" />
    </div>
  );
}
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Reminder details">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[7.758px] items-center pl-0 pr-[7.758px] py-0 relative w-full">
          ...
          <div className="css-g0mm18 flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[#214677] text-[8.243px] text-ellipsis">
...
function ReminderColours() {
  return (
    <div className="h-[229.154px] relative rounded-tl-[20px] rounded-tr-[20px] shrink-0 w-[195.025px]" data-name="Reminder colours">
      <div className="bg-[#214677] h-full w-full rounded-tl-[20px] rounded-tr-[20px]" style={{ paddingTop: '9.751px', paddingLeft: '9.751px', paddingRight: '9.751px', boxSizing: 'border-box' }}>
