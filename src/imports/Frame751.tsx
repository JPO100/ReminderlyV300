    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-start min-h-px min-w-px relative">
      <div className="h-[21px] relative shrink-0 w-[24.46px]" data-name="Union">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.4599 21.0002">
          <g id="Union">
            <path d={svgPaths.p2515f980} fill="var(--fill-0, #1C2C42)" />
            <path d={svgPaths.p20872d70} fill="var(--fill-0, #1C2C42)" />
            <path d={svgPaths.p1d735a00} fill="var(--fill-0, #1C2C42)" />
            <path d={svgPaths.p33ae7180} fill="var(--fill-0, #1C2C42)" />
            <path d={svgPaths.p1ed57680} fill="var(--fill-0, #1C2C42)" />
          </g>
        </svg>
      </div>
      <Frame1 />
