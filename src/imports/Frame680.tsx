    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-start min-h-px min-w-px relative">
      <div className="h-[24px] relative shrink-0 w-[22.9px]" data-name="Union">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.9004 24">
          <g id="Union">
            <path d={svgPaths.p10ad3640} fill="#1C2C42" />
            <path d={svgPaths.pe9ba000} fill="#1C2C42" />
            <path d={svgPaths.p1ffae300} fill="#1C2C42" />
            <path d={svgPaths.paf45580} fill="#1C2C42" />
            <path d={svgPaths.pc271000} fill="#1C2C42" />
            <path clipRule="evenodd" d={svgPaths.pd7cba80} fill="#1C2C42" fillRule="evenodd" />
          </g>
        </svg>
      </div>
      <Frame2 />
