import svgPaths from "./svg-edwk2jdpqv";
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Reminder details">
      <div className="flex flex-row items-start size-full">
        <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
          <DoneTick />
          <div className="flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#1c2c42] text-[11.834px]" style={{ gap: '2px', marginTop: '1px' }}>
            ...
            <p className="[text-decoration-skip-ink:none] leading-[normal] line-through overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: '#1c2c42' }}>Yesterday at 10:00 AM</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="absolute inset-[-0.29%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.4033 17.453">
          <g id="Set time clock">
            ...
            <circle cx="8.70166" cy="8.70166" id="Ellipse 1116" r="8.00552" stroke="var(--stroke-0, #1C2C42)" strokeWidth="1.39227" />
            <path d={svgPaths.p1a0aa740} id="Vector" stroke="var(--stroke-0, #1C2C42)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.39227" />
          </g>
        </svg>
      </div>
    </div>
      ...
      <div className="flex flex-row items-start size-full">
        <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#1c2c42] text-[11.834px]" style={{ gap: '2px', marginTop: '1px' }}>
            ...
            <p className="[text-decoration-skip-ink:none] leading-[normal] line-through overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: '#1c2c42' }}>Tuesday at 3:00 PM</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="flex flex-row items-start size-full">
        <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#1c2c42] text-[11.834px]" style={{ gap: '2px', marginTop: '1px' }}>
            ...
            <p className="[text-decoration-skip-ink:none] leading-[normal] line-through overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: '#1c2c42' }}>Every Wednesday</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="absolute h-[17.452px] left-0 top-0 w-[17.404px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.4035 17.4527">
        <g id="Group 23">
          <g id="Group 20">
            <path d={svgPaths.p3f72ea80} fill="var(--fill-0, #1C2C42)" id="Vector" />
            <path d={svgPaths.p20bae400} fill="var(--fill-0, #1C2C42)" id="Union" />
          </g>
          <path d={svgPaths.p380e0c00} id="Vector_2" stroke="var(--stroke-0, #1C2C42)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.39227" />
        </g>
      </svg>
    </div>
  );
...
function ThisWeekRepeatTimeIcon() {
  return (
      ...
      <div className="flex flex-row items-start size-full">
        <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#1c2c42] text-[11.834px]" style={{ gap: '2px', marginTop: '1px' }}>
            ...
            <p className="[text-decoration-skip-ink:none] leading-[normal] line-through overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: '#1c2c42' }}>Today at 5:30 PM</p>
          </div>
        </div>
      </div>
    </div>
