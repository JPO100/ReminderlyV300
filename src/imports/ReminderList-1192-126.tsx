  ...
  return (
    <div className="relative shrink-0 size-[17.403px]" data-name="No time clock">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.403 17.403">
        <path d={svgPathsUnion.p30e85d80} fill={color} />
        <path d={svgPathsUnion.p1a190b80} fill={color} />
        <path d={svgPathsUnion.p41fdf00} fill={color} />
        <path d={svgPathsUnion.p398be80} fill={color} />
        <path d={svgPathsUnion.p366e180} fill={color} />
        <path d={svgPathsUnion.p16ffba00} fill={color} />
        <path d={svgPathsUnion.p3493080} fill={color} />
      </svg>
    </div>
  );
}
