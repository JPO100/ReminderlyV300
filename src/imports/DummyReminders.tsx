          ...
          <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Reminder details">
            <div className="flex flex-row items-center size-full">
              <div className="content-stretch flex gap-[16px] items-center pr-[16px] relative w-full">
                ...
                <div className={`flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[17px] text-ellipsis whitespace-nowrap${isDone || strikethrough ? ' line-through' : ''}`} style={{ color: textColor || '#2B5DA0' }}>
          ...
          <div className="flex items-center gap-[20px] shrink-0 w-[105px]">
            ...
            <button className="relative shrink-0 size-[25px] cursor-pointer bg-transparent border-none p-0 flex items-center justify-center" data-name="icon-repeats" onClick={onToggleRepeat} aria-label="Toggle repeat">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25.0003 25.0708">
                <g>
                  <path d={repeatIconPaths.p19a7b000} fill={repeatActive ? "#2B5DA0" : "#BABABA"} />
                  <path d={repeatIconPaths.p9f3c880} fill={repeatActive ? "#2B5DA0" : "#BABABA"} />
                  <path d={repeatIconPaths.pf2d2300} fill={repeatActive ? "#2B5DA0" : "#BABABA"} />
                </g>
              </svg>
            </button>
            )}
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-start relative w-full" data-name="Scrollable List Area" style={{ flex: 1, minHeight: 0, overflowY: 'auto' }}>
          ...
          >
            <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
              <p className="font-['Lato:Bold',sans-serif] leading-[23px] not-italic text-[17px]" style={{ color: hideOverdue ? '#2B5DA0' : '#C9C9C9' }}>Hide overdue reminders</p>
            </div>
            <div
          ...
          <ReminderRow label="'Done' reminders" color="#2B5DA0" defaultCount="05" value={counts.done} onChange={updateCount('done')} isDone repeatActive={repeats.done} onToggleRepeat={toggleRepeat('done')} />
