...
function SavedListOverlayCheckCircle() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 25" aria-hidden="true">
      <circle cx="12.5" cy="12.5" fill="white" r="11.5" stroke="#1C2C42" strokeWidth="2" />
    </svg>
  );
}
...
export default function App() {
  ...
  const devToolsSheetDragControls = useDragControls();
              ...
              >
                ...
                <div className="relative shrink-0 w-full max-w-[768px] h-full flex flex-col">
                  <div className="content-stretch flex flex-col gap-[30px] items-start pt-[31px] px-[24px] relative w-full shrink-0">
                    ...
                    }} isEmpty={listItems.length === 0} accentColor={isSavedListCreateOverlay ? '#1C2C42' : currentListAccentColor} idleCircleColor="#D9D9D9" />
                  </div>
        ...
        {isDevToolsOpen && (
          <>
            ...
            >
              <motion.div
                drag="y"
                dragControls={devToolsSheetDragControls}
                dragListener={false}
                dragConstraints={{ top: 0, bottom: viewportHeight }}
                dragElastic={0}
                dragMomentum={false}
