...
type DevToolsPage = 'home' | 'tests' | 'test-data' | 'dummy-reminders' | 'dummy-lists' | 'nlc' | 'filters-menu' | 'onboarding-tutorial' | 'dev-tools-password' | 'reminder-settings' | 'list-settings' | 'paywall';
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start relative w-full">
            ...
            >
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                <div className="h-[20px] relative shrink-0 w-[20px]">
                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                    <path d="M10.8333 1.66675C10.8333 1.20651 10.4602 0.833415 10 0.833415C9.53976 0.833415 9.16667 1.20651 9.16667 1.66675V5.41049L6.07741 8.49976C5.75197 8.82519 5.75197 9.35283 6.07741 9.67827C6.40285 10.0037 6.93048 10.0037 7.25592 9.67827L9.16667 7.76752V18.3334C9.16667 18.7937 9.53976 19.1667 10 19.1667C10.4602 19.1667 10.8333 18.7937 10.8333 18.3334V7.76752L12.7441 9.67827C13.0695 10.0037 13.5972 10.0037 13.9226 9.67827C14.248 9.35283 14.248 8.82519 13.9226 8.49976L10.8333 5.41049V1.66675Z" fill={pinnedListsEnabled ? '#1C2C42' : '#C9C9C9'} />
                  </svg>
                </div>
  ...
  if (!isDevToolsUnlocked) {
    ...
    content = (
      <DevToolsHome
        ...
        onNavigateTestData={() => setPage('test-data')}
    ...
    content = (
      <ListSettingsPage onBack={() => setPage('home')} onClose={onClose} useDefaultTemplatesInCleanState={useDefaultTemplatesInCleanState} onUseDefaultTemplatesInCleanStateChange={onUseDefaultTemplatesInCleanStateChange} />
    );
