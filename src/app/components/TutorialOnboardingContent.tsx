...
function TemplatesTutorialButton() {
  return (
    <div className="bg-[#214677] content-stretch flex items-center justify-center px-[11.487px] h-[28.718px] relative rounded-[71.795px] shrink-0">
      ...
      <div className="flex items-center justify-between gap-[10px]">
        <div className="flex items-center gap-[8px]">
          <div
            ...
            style={{ boxShadow: "inset 0 0 0 1.392px #214677", color: "#214677" }}
          >
        ...
        <div className="content-stretch flex items-center justify-center h-[28px] w-[66px] relative rounded-[69.652px] shrink-0 border border-solid border-[#214677] text-[#214677]">
          <div className="font-['Lato',sans-serif] font-bold text-[9.751px] whitespace-nowrap">
            Clear all
          </div>
        </div>
                  ...
                  {showAddHighlight && addButtonRect && (
                    ...
                    >
                      <svg width="50" height="50" viewBox="0 0 50 50" fill="none">
                        <circle cx="25" cy="25" r="23.5" stroke="#214677" strokeWidth="3" />
                      </svg>
                    </motion.div>
                  )}
                  {showMenuDotsHighlight && menuDotsRect && (
                    ...
                    >
                      <svg width="35" height="35" viewBox="0 0 35 35" fill="none">
                        <circle cx="17.5" cy="17.5" r="16" stroke="#214677" strokeWidth="3" />
                      </svg>
                    </motion.div>
                  )}
                </div>
              ...
              {showTickThrob && tickButtonRect && (
                ...
                >
                  <svg width={SMART_REMINDER_TICK_THROB_CIRCLE_SIZE} height={SMART_REMINDER_TICK_THROB_CIRCLE_SIZE} viewBox={`0 0 ${SMART_REMINDER_TICK_THROB_CIRCLE_SIZE} ${SMART_REMINDER_TICK_THROB_CIRCLE_SIZE}`} fill="none">
                    <circle cx={SMART_REMINDER_TICK_THROB_CIRCLE_SIZE / 2} cy={SMART_REMINDER_TICK_THROB_CIRCLE_SIZE / 2} r={SMART_REMINDER_TICK_THROB_CIRCLE_SIZE / 2 - 1.5} stroke="#214677" strokeWidth="3" />
                  </svg>
                </motion.div>
              )}
            </motion.div>
                ...
                <TutorialMiniOverlayShell>
                  <div className="bg-white relative flex flex-col gap-[25px] items-center pt-[35px] pb-[35px] px-[32px] rounded-[32px] outline-none">
                    ...
                    <div className="content-stretch flex flex-col gap-[30px] items-start relative shrink-0 w-full">
                      <div className="h-[50px] relative rounded-[100px] shrink-0 w-full" style={{ backgroundColor: '#214677' }}>
                                            ...
                                            <div className="content-stretch flex gap-[16px] items-start pr-[16px] relative w-full min-w-0">
                                              ...
                                              <div className="flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-start min-h-px min-w-0 not-italic overflow-visible relative" style={{ gap: '9px', minHeight: '38px' }}>
                                                <div
                                                  ...
                                                  style={{ color: '#214677', textDecorationColor: '#214677', clipPath: 'inset(0 0 -4px 0)' }}
                                                >
