...
function Frame1({ isListsEnabled }: { isListsEnabled: boolean }) {
  return (
    <div className={`bg-white flex-[1_0_0] min-h-px min-w-px relative w-full ${isListsEnabled ? 'rounded-tl-[15px] rounded-tr-[15px]' : 'rounded-[13.96px]'}`} style={{ marginTop: isListsEnabled ? '0px' : '-66px' }}>
...
export default function OnboardingPage4Content({ filtersMenuVariant, isListsEnabled = false }: { filtersMenuVariant: FiltersMenuVariant; isListsEnabled?: boolean }) {
