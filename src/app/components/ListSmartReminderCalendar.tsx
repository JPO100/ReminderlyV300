      ...
      <div className="relative shrink-0 w-full pt-[20px] pb-[16px] px-[4px]">
        <div className="flex flex-row items-center justify-between size-full">
          <div className="content-stretch flex gap-[3px] items-center relative shrink-0">
            <p className="font-['Lato:Bold',sans-serif] leading-[normal] relative shrink-0 text-[17px] text-[#4784F8] tracking-[-0.2px]">
              {formatMonthYear(viewYear, viewMonth)}
            </p>
          </div>
          <div
            className="content-stretch flex items-center justify-end gap-[32px] leading-[normal] ml-auto relative shrink-0 text-[#4784F8] text-nowrap"
          >
            <button
        ...
        {Array.from({ length: daysInMonth }, (_, index) => {
          ...
          return (
            <button
              ...
              className={`${isSelected ? "bg-[#4784F8]" : ""} content-stretch flex flex-col h-[35px] items-center justify-center justify-self-stretch relative rounded-[99px] shrink-0 cursor-pointer`}
              style={{ gridColumn: col, gridRow: row }}
              data-name="datepicker-day"
            >
              <p className={`font-['Lato:Bold',sans-serif] leading-[normal] relative shrink-0 text-[17px] text-center ${isSelected ? "text-white" : "text-[#4784F8]"}`}>
                {day}
              </p>
            </button>
          );
