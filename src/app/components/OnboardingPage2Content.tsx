              ...
              <div className="flex-[1_0_0] min-h-px min-w-px relative">
                <div className="flex flex-row items-start size-full">
                  <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
                    ...
                    <div
                      className={`flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#2B5DA0] text-[11.834px] ${doneStates[0] ? 'line-through' : ''}`}
                      style={{ gap: '2px' }}
                    >
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap">Pick the milk up</p>
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: doneStates[0] ? '#2B5DA0' : '#BABABA' }}>Today at 2:00 PM</p>
                    </div>
                    {showDoneText[0] && (
                      <motion.div
                        initial={{ opacity: 0 }}
                        ...
                        className="css-g0mm18 flex flex-col font-['Lato'] font-bold justify-center leading-[0] italic overflow-hidden relative shrink-0 text-[#2B5DA0] text-[11.834px] text-ellipsis text-right"
                      >
              ...
              <div className="flex-[1_0_0] min-h-px min-w-px relative">
                <div className="flex flex-row items-start size-full">
                  <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
                    ...
                    <div
                      className={`flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#2B5DA0] text-[11.834px] ${doneStates[1] ? 'line-through' : ''}`}
                      style={{ gap: '2px' }}
                    >
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap">Put the bins out</p>
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: doneStates[1] ? '#2B5DA0' : '#BABABA' }}>Thursday</p>
                    </div>
                    {showDoneText[1] && (
                      <motion.div
                        initial={{ opacity: 0 }}
              ...
              <div className="flex-[1_0_0] min-h-px min-w-px relative">
                <div className="flex flex-row items-start size-full">
                  <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
                    ...
                    <div
                      className={`flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#2B5DA0] text-[11.834px] ${doneStates[2] ? 'line-through' : ''}`}
                      style={{ gap: '2px' }}
                    >
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap">Water house plants</p>
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: doneStates[2] ? '#2B5DA0' : '#BABABA' }}>25th March</p>
                    </div>
                    {showDoneText[2] && (
                      <motion.div
                        initial={{ opacity: 0 }}
              ...
              <div className="flex-[1_0_0] min-h-px min-w-px relative">
                <div className="flex flex-row items-start size-full">
                  <div className="content-stretch flex gap-[11.138px] items-start pl-0 pr-[11.138px] py-0 relative w-full">
                    ...
                    <div
                      className={`flex flex-[1_0_0] flex-col font-['Lato:Bold',sans-serif] justify-center min-h-px min-w-px not-italic overflow-hidden relative text-[#2B5DA0] text-[11.834px] ${doneStates[3] ? 'line-through' : ''}`}
                      style={{ gap: '2px' }}
                    >
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap">Organise family photos</p>
                      <p className="leading-[normal] overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontSize: '9.4px', fontWeight: 600, fontFamily: "'Lato', sans-serif", color: doneStates[3] ? '#2B5DA0' : '#BABABA' }}>No date / time set</p>
                    </div>
                    {showDoneText[3] && (
                      <motion.div
                        initial={{ opacity: 0 }}
