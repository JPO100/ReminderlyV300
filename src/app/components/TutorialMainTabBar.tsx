export default function TutorialMainTabBar() {
  return (
    <div className="content-stretch flex gap-[10px] items-end justify-center px-[14px] relative w-full">
      <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-tl-[12px] rounded-tr-[12px] h-[34px]">
      ...
      <div className="bg-[rgba(255,255,255,0.25)] flex-[1_0_0] min-h-px min-w-px relative rounded-tl-[12px] rounded-tr-[12px] h-[34px]">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[18px] relative size-full">
